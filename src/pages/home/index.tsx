              ...
              <h1 className="m-0">
                <a href="#">
                  <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                    <title>FaviconGenerator.io</title>
                    <defs>
          ...
          <div className="container">
            <div className="hero-inner">
              <div className="hero-copy">
                <h1 className="hero-title mt-0 is-revealing">FaviconGenerator.io</h1>
                <p className="hero-paragraph is-revealing">
                  Some kinda message about how awesome it is to subscribe to our newsletter.
                </p>
                ...
                <div className="feature">
                  <div className="feature-inner">
                    <div className="feature-header mb-16">
                      ...
                      <h4 className="feature-title m-0">Generate Favicon</h4>
                    </div>
                    <p className="text-sm mb-0">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Necessitatibus laboriosam ab, temporibus
                      similique atque quibusdam!
                    </p>
                  </div>
                </div>
                <div className="feature">
                  <div className="feature-inner">
                    <div className="feature-header mb-16">
                      ...
                      <h4 className="feature-title m-0">Other Icons</h4>
                    </div>
                    <p className="text-sm mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                  </div>
                </div>
                <div className="feature">
                  <div className="feature-inner">
                    <div className="feature-header mb-16">
                      ...
                      <h4 className="feature-title m-0">Icons</h4>
                    </div>
                    <p className="text-sm mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                  </div>
                </div>
      ...
      <footer className="site-footer">
        ...
        <div className="container">
          <div className="site-footer-inner has-top-divider">
            <div className="footer-copyright">&copy; 2020 FaviconGenerator.io, all rights reserved</div>
